 ...
 */
@FunctionalInterface
public interface SyncPromiseListFunction<T, O> extends SyncPromiseFunction<T, Collection<O>>, PromiseListFunction<T, O> {
    /**
     ...
     */
    Collection<O> handle(T data) throws Throwable;
}
